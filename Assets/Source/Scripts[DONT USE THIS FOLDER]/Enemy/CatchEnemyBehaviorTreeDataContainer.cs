...
{
    public class CatchEnemyBehaviorTreeDataContainer : EnemyBehaviorTreeDataContainer
    {
        ...
        [SerializeField] private MoveEnemyTowardAttackPoint _moveEnemyTowardAttackPoint;
        
        public override GameActionContainer GetAttackActionsContainer()
        {
            return new(new List<IGameAction>() {_moveEnemyTowardAttackPoint});
        }
